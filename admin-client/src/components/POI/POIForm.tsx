...
function PointOfInterestForm({
  resortId,
  onSaveSuccess,
  onCancel,
  editingPoi,
}: PointOfInterestFormProps) {
  const [name, setName] = useState(editingPoi ? editingPoi.name : "");
      ...
      >
        <FormControl>
          ...
          <Input
            ...
            placeholder="e.g., Top of Panorama"
          />
        </FormControl>
        <FormControl>
          ...
          <Input
            ...
            placeholder="e.g., Lunch Rock, Sunspot Lodge"
          />
        </FormControl>
